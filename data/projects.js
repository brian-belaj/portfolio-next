export const projects = [
  {
    ...
    description: {
      ...
      en: "For YouFix, I developed a custom WordPress website designed to support an e-commerce platform with a large and complex product structure. I worked on both the frontend and WooCommerce customization to make catalog browsing clearer and content management easier. The result is a solid, scalable platform that is easier to use for both the client and its customers.",
    },
    client: {
      it: "Youfixing Srl",
      en: "Youfixing Srl",
  ...
  },
  {
    ...
    description: {
      ...
      en: "For Bluegame Yachts, I developed a WordPress website starting from an existing base and adapting it to the brand’s needs. I customized layouts, content, and features to showcase the fleet, improve content management, and ensure smooth navigation across all devices. The result is a website that reflects the brand’s identity, is easy to browse, and simple to update.",
    },
    client: {
      it: "Bluegame Yachts",
    },
  ...
  },
  {
    ...
    description: {
      ...
      en: "For Sanlorenzo Charter Fleet, I built a fully custom WordPress website designed to showcase the brand’s fleet and services. I developed a responsive interface, more flexible content management, and dedicated features for yachts, contacts, and galleries. The result is an elegant, high-performing website that is easier to manage and delivers a smooth experience across desktop and mobile.",
    },
    client: {
      it: "Sanlorenzo Charter Fleet",
    },
    isFeatured: false,
    githubUrl: "",
    liveUrl: "https://sanlorenzocharterfleet.com/",
  ...
  },
  {
    ...
    description: {
      ...
      en: "For Maria Gabriella Crotti’s website, I handled the development with a strong focus on the brand’s visual identity and collection presentation. I worked on structure, layout, and content management to create a refined, well-organized, and easy-to-update experience. The result is an elegant website aligned with the brand’s positioning and designed to guide users through the collection.",
    },
    client: {
      it: "Maria Gabriella Crotti",
    },
...
export function getProject(slugOrId) {
  ...
  return projects.find((p) => p.slug === key || String(p.id) === key);
}
